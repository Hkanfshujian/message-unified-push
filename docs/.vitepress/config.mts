...
export default defineConfig({
  title: "ops-message-unified-push",
  description: "灵活而强大的消息推送整合平台",
  lang: 'zh-CN',
  
  // 如果部署到 GitHub Pages 的子路径，需要设置 base
  // 例如：https://engigu.github.io/ops-message-unified-push/
  // base: '/ops-message-unified-push/',
  ...
  // 网站图标
  head: [
    ['link', { rel: 'icon', href: '/ops-message-unified-push/logo.svg' }]
  ],
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'API', link: '/api/v2' },
      { text: '演示站点', link: 'https://ops-message-unified-push-demo-site.qwapi.eu.org/' }
    ],
      ...
      '/api/': [
        {
          text: 'API文档',
          items: [
            { text: 'V2 API（推荐）', link: '/api/v2' },
            { text: 'API 使用说明', link: '/api/usage' },
            { text: 'API 调用示例', link: '/api/examples' }
          ]
        }
      ]
    },
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/engigu/ops-message-unified-push' }
    ],

    footer: {
      message: 'Released under the MIT License.',
      copyright: 'Copyright © 2024-present ops-message-unified-push'
    },

...
本文档介绍如何在开发环境中运行 ops-message-unified-push。
...
```bash
git clone https://github.com/engigu/ops-message-unified-push.git
cd ops-message-unified-push
```
...
```bash
CGO_ENABLED=0 go build -o ops-message-unified-push
```

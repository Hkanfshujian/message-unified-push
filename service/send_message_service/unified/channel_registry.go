...
import (
	"fmt"
	"ops-message-unified-push/service/send_message_service/unified/channels"
	"sync"
)
...
const (
	...
	MessageTypeQyWeiXinApp     = channels.MessageTypeQyWeiXinApp
)
...
func GetGlobalChannelRegistry() *ChannelRegistry {
	channelRegistryOnce.Do(func() {
		...
		globalChannelRegistry.Register(channels.NewQyWeiXinAppChannel())
	})
